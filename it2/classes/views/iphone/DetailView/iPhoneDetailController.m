...
-(void)configureCell:(MasterCell*)cell atIndexPath:(NSIndexPath*)indexPath
{
    ...
    switch (type) {
        case 0:
            ...
            cell.textLabel.text = NSLocalizedString(@"Pregledajte video ili ga snimite na svoj uređaj.", @"content type description");
            ...
            if([AppDelegate instance].allowSaveVideoToCameraRoll) {
                ...
                if(nil != file) {
                    ...
                    sv.frame = CGRectMake(250, 7, 30, 25);
        ...
        case 1:
            ...
            cell.textLabel.text = NSLocalizedString(@"Preslušajte ovo predavanje ukoliko niste u mogućnosti da ga pregledate.", @"content type description");
            [cell.avatarImageView setImage:[UIImage imageNamed:@"headphones.png"]];
            break;
        case 2:
            // text
            cell.titleLabel.text = NSLocalizedString(@"Text", @"content type");
            cell.textLabel.text = NSLocalizedString(@"Pročitajte ovu lekciju. Pomoći će vam da je bolje razumijete. ", @"content type description");
            [cell.avatarImageView setImage:[UIImage imageNamed:@"paper.png"]];
            break;
        case 3:
            // quiz
            cell.titleLabel.text = NSLocalizedString(@"Quiz", @"content type");
            cell.textLabel.text = NSLocalizedString(@"Testirajte se. Rezultati će biti snimljeni u oblak.", @"content type description");
            [cell.avatarImageView setImage:[UIImage imageNamed:@"penpaper.png"]];
            break;
        case 4:
            // todo
            cell.titleLabel.text = NSLocalizedString(@"ToDo", @"content type");
            cell.textLabel.text = NSLocalizedString(@"Čeklista za predavanje.", @"content type description");
    ...
    if(type == 0) {
        ...
        if(nil != file) {
            ...
            if(UIVideoAtPathIsCompatibleWithSavedPhotosAlbum(file)) {
                ...
                NSLog(@"Video file nije kompatibilan: %@", file);
            }
        }
    }
}
...
-(void)videoTrackSavedToCameraRoll:(NSString*)file withError:(NSError*)error userData:(void*)data
{
    ...
    NSString *msg = NSLocalizedString(@"je snimljen na uređaj.", @"file saved message");
