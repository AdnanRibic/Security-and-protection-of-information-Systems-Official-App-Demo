...
- (void)viewDidLoad
{
    self.title = NSLocalizedString(@"Materijali", @"iPhone main tab");
...
-(void)firstStart2:(id)sender
{
    ...
    CMPopTipView *helpPopTipView = [[CMPopTipView alloc] initWithMessage:NSLocalizedString(@"Pritisni ovdje za pomoć.", @"button tip")];
