...
//#ifndef NOADS ////REKLAME SA POCETNE STRANICE, TREBA UKINUT
//    if(AdMob) {
...
{
    barButtonItem.title = NSLocalizedString(@"Sadržaj", @"button");
...
-(void)startDownloadingCourse:(id)sender
{
    ...
    BlockAlertView *alert = [BlockAlertView alertWithTitle:NSLocalizedString(@"Početak preuzimanja", @"download confirmation") message:NSLocalizedString(@"Da li želite da preuzmete čitav kurs??", @"download confirmation")];
